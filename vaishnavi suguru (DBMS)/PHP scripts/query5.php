...
$query = "SELECT customer.C_name,restaurant.R_name,restaurant.R_rating FROM dines
INNER JOIN restaurant ON restaurant.R_ID=dines.R_ID 
INNER JOIN customer ON dines.C_ID=customer.C_ID WHERE restaurant.R_rating='".$qz."'";
